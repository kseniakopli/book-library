...
MESSAGES = {
    ...
    "series_not_found": {"ru": "Цикл не найден", "en": "Series not found"},
    "book_title_required": {"ru": "Укажите название книги", "en": "Book title is required"},
    "series_name_required": {"ru": "Название цикла не может быть пустым",
                             "en": "Series name is required"},
    "bad_series_status": {"ru": "Статус цикла должен быть reading, read или dropped",
                          "en": "Series status must be reading, read or dropped"},
