...
# Задача 30: публичная витрина — тоже открыта: на неё ведут QR печатных
# карточек, её открывает человек, который про сервис ещё не знает.
# Отдаёт ТОЛЬКО отмеченные книги и их атмосферу, без личных данных.
